  ...
  return (
    <footer className="border-t border-white/25 bg-black text-white">
      <div className="border-b border-white/20">
        <Container className="max-w-[1228px]">
          <div className="grid pt-[67px] pb-[51px] md:grid-cols-[307px_1fr_309px] md:items-start md:gap-0 md:pt-[92px] md:pb-[88px]">
            <div className="order-2 mt-[43px] w-full border-white/30 md:order-1 md:mt-0 md:max-w-[307px] md:border-y">
              {socialLinks.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
                  aria-label={item.label}
                  className="grid h-[67px] grid-cols-[1fr_auto] items-center border-b border-white/30 font-sans-brand text-base leading-none text-white transition-colors hover:text-white/70 md:h-[58px] md:grid-cols-[122px_1fr] md:text-xl md:last:border-b-0"
                >
            ...
            <Link
              ...
              className="order-1 justify-self-center md:order-2 md:mt-[8px]"
            >
              <Image
                width={286}
                height={243}
                ...
                className="h-auto w-[123px] md:w-[178px]"
              />
            </Link>

            <address className="order-3 w-full border-white/30 pt-[28px] not-italic md:mt-1 md:max-w-[309px] md:justify-self-end md:border-y md:py-[27px]">
              <div className="flex items-start justify-between gap-5">
                <MapPinIcon />
                <h2 className="font-serif-brand text-[1.0625rem] leading-[1.2] text-white md:text-[22px]">
                  Our Office Address
                </h2>
              </div>
              <p className="mt-[21px] ml-auto max-w-[256px] text-right font-sans-brand text-[0.9375rem] leading-[1.35] text-white md:pl-10 md:text-left md:text-base md:leading-6">
      ...
      <Container className="max-w-[1228px]">
        <p className="py-4 font-sans-brand text-[0.5625rem] leading-4 text-white md:py-[29px] md:text-[13px]">
...
function MapPinIcon() {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
      className="mt-[2px] h-[20px] w-[20px] shrink-0 fill-current text-white"
    >
