          ...
          <div className="grid pt-28 pb-24 lg:grid-cols-[minmax(0,25rem)_minmax(12rem,1fr)_minmax(18rem,26rem)] lg:items-start lg:gap-0 lg:pt-25 lg:pb-25">
            ...
            >
              <Image
                ...
                className="h-auto w-44 md:w-40 xl:w-56"
              />
            </Link>
            ...
            <address className="order-3 w-full border-white/30 pt-11 not-italic lg:mt-1 lg:border-y lg:py-7 lg:pl-6">
              <div className="grid grid-cols-[4rem_minmax(0,1fr)] items-start lg:flex lg:gap-5">
                <MapPinIcon />
                <div>
                  <h2 className="text-right font-serif-brand text-2xl leading-tight text-white sm:text-3xl md:text-3xl lg:text-left">
                    Our Office Address
                  </h2>
                  <p className="mt-9 text-right font-sans-brand text-xl leading-[1.45] text-white sm:text-2xl md:text-3xl lg:mt-5 lg:text-left lg:text-base lg:leading-6">
...
function LinkedInIcon() {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
      className="h-5 w-5 shrink-0 fill-current lg:h-6 lg:w-6 xl:h-7 xl:w-7"
    >
...
function InstagramIcon() {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
      className="h-5 w-5 shrink-0 lg:h-6 lg:w-6 xl:h-7 xl:w-7"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
    >
